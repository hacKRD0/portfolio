        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              ...
              <h1 className="font-bold lg:text-2xl md:text-xl text-basae line-clamp-1">
                {title}
              </h1>
                  ...
                  {iconLists.map((icon, index) => (
                    ...
                    >
                      <img
                        src={icon}
                        alt={icon}
                        className="p-2 rounded-full bg-black flex justify-center items-center lg:w-10 lg:h-10 w-8 h-8"
